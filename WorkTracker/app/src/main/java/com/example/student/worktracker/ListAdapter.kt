...
class ListAdapter (private val context: Activity, private val category: ArrayList<String>, private val date: ArrayList<String>,private val worktime: ArrayList<String>)
